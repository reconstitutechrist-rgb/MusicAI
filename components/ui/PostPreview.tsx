...
const CommentIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M18 10c0 3.866-3.582 7-8 7a8.841 8.841 0 01-4.083-.98L2 17l1.08-3.242A8.92 8.92 0 012 10c0-3.866 3.582-7 8-7s8 3.134 8 7zM4.416 14.653a6.945 6.945 0 003.584.98c4.418 0 8-3.134 8-7s-3.582-7-8-7-8 3.134-8 7c0 1.56.45 3.02 1.238 4.28l-.51 1.531 1.688-.562z"
      clipRule="evenodd"
    />
  </svg>
);
