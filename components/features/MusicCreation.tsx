...
const MusicCreation: React.FC<MusicCreationProps> = ({ onLyricsGenerated }) => {
  ...
  const handleChatSend = async (overrideInput?: string) => {
    ...
    try {
      ...
      const errorMessage: ChatMessage = {
        role: "model",
        text: "Sorry, I ran into a creative block. Could you try phrasing that differently?",
      };
  ...
  const handleRegenerateText = async () => {
    ...
    try {
      ...
      const errorMessage: ChatMessage = {
        role: "model",
        text: "Sorry, I ran into a creative block while regenerating. Could you try phrasing that differently?",
      };
          ...
          prev.map((msg, idx) =>
            idx === messageIndex
              ? {
                  ...
                  text:
                    msg.text +
                    "\n\nSorry, I encountered an issue generating one of the audio tracks.",
                }
              : msg
          )
        );
